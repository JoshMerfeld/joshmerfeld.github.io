...
**Improving Estimates of Mean Welfare and Uncertainty in Developing Countries** with Hai-Anh Dang and David Newhouse. World Bank Policy Research Working Paper 10348. Second revision requested, _Review of Economics and Statistics_.<br/>
...
**Gender and hiring in SMEs: Evidence from an RCT in Bangladesh** with Emily Beam and Naveen Wickremeratne (funding: £225,000). Revision requested, _Journal of Development Economics_ (pre-results review).<br/>
...
<small>[ <a href="#/" onclick="visib('povAbstract')">Abstract</a> | [Draft](/assets/papers/merfeldmorduch2024.pdf) | [Most recent slides](/merfeldmorduch-slides/#1) | <a href="#/" onclick="visib('mediapov')">Media coverage</a> ] </small>
...
<small>
<ul>
  <li><a href="https://www.ideasforindia.in/topics/poverty-inequality/india-s-poverty-rate-does-not-measure-what-you-think-it-does.html">Ideas for India</a></li>
</ul>
</small><br><br/></div>
